namespace Voxels.Core.ThirdParty.SurfaceNets.Intrinsics
{
	...
	public static unsafe partial class X86F
	{
		...
		public static class Sse2
		{
			...
			/// </summary>
			/// <param name="memAddr">Memory address</param>
			/// <param name="a">32-bit integer</param>
			public static void stream_si32(int* memAddr, int a)
			{
				*memAddr = a;
			}
			...
			public static void stream_si64(long* memAddr, long a)
			{
				*memAddr = a;
			}

			/// <summary>
			///   Store 128-bits (composed of 2 packed double-precision (64-bit) floating-point elements) from "a" into memory using a
			///   non-temporal memory hint. "mem_addr" must be aligned on a 16-byte boundary or a general-protection exception will be
			///   generated.
			/// </summary>
			/// <param name="memAddr">Memory address</param>
			/// <param name="a">Vector a</param>
			public static void stream_pd(void* memAddr, v128 a)
			{
				GenericCSharpStore(memAddr, a);
			}

			/// <summary>
			///   Store 128-bits of integer data from a into memory using a non-temporal memory hint.mem_addr must be aligned on a
			///   16-byte boundary or a general-protection exception may be generated.
			/// </summary>
			/// <param name="memAddr">Memory address</param>
			/// <param name="a">Vector a</param>
			public static void stream_si128(void* memAddr, v128 a)
			{
				GenericCSharpStore(memAddr, a);
			}
			...
			// _mm_mulhi_epi16
			/// <summary>
			///   Multiply the packed 16-bit integers in "a" and "b", producing intermediate 32-bit integers, and store the
			///   high 16 bits of the intermediate integers in "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			/// <returns>Vector</returns>
			...
			// _mm_mulhi_epu16
			/// <summary>
			///   Multiply the packed unsigned 16-bit integers in "a" and "b", producing intermediate 32-bit integers, and
			///   store the high 16 bits of the intermediate integers in "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			/// <returns>Vector</returns>
			...
			{
				var dst = default(v128);
				dst.ULong0 = a.UInt0 * (ulong)b.UInt0;
				dst.ULong1 = a.UInt2 * (ulong)b.UInt2;
				return dst;
			}
			...
			///   consecutive 8 differences to produce two unsigned 16-bit integers, and pack these unsigned 16-bit integers in the low
			...
			// _mm_subs_epi8
			/// <summary>
			///   Subtract packed 8-bit integers in "b" from packed 8-bit integers in "a" using saturation, and store the
			///   results in "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			// _mm_subs_epi16
			/// <summary>
			///   Subtract packed 16-bit integers in "b" from packed 16-bit integers in "a" using saturation, and store the
			///   results in "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			{
				var dist = math.min(imm8 & 0xff, 16);
				var dst = default(v128);
				var dptr = &dst.Byte0;
				var aptr = &a.Byte0;
			...
			public static v128 bsrli_si128(v128 a, int imm8)
			{
				...
				var dptr = &dst.Byte0;
				var aptr = &a.Byte0;
				for (var j = 0; j < 16 - dist; ++j)
					dptr[j] = aptr[dist + j];

				for (var j = 16 - dist; j < 16; ++j)
					dptr[j] = 0;
			...
			{
				var dst = default(v128);
				var dist = (int)math.min(count.ULong0, 16);
				var dptr = &dst.UShort0;
				var aptr = &a.UShort0;
				for (var j = 0; j <= 7; j++)
					if (dist > 15)
			...
			{
				var dst = default(v128);
				var dist = math.min(imm8 & 0xff, 32);
				...
				{
					dst.UInt0 = a.UInt0 << dist;
					dst.UInt1 = a.UInt1 << dist;
					dst.UInt2 = a.UInt2 << dist;
					dst.UInt3 = a.UInt3 << dist;
				}

				// Original takes a pointer of v128 which Unity does not like at all.
			...
			{
				var dst = default(v128);
				var dist = (int)math.min(count.ULong0, 32);
				var dptr = &dst.UInt0;
				var aptr = &a.UInt0;
				for (var j = 0; j <= 3; j++)
					if (dist > 31)
			...
			{
				var dst = default(v128);
				var dist = math.min(imm8 & 0xff, 64);
				var dptr = &dst.ULong0;
				var aptr = &a.ULong0;
				for (var j = 0; j <= 1; j++)
					if (dist > 63)
			...
			{
				var dst = default(v128);
				var dist = (int)math.min(count.ULong0, 64);
				var dptr = &dst.ULong0;
				var aptr = &a.ULong0;
				for (var j = 0; j <= 1; j++)
					if (dist > 63)
			...
			// _mm_and_si128
			/// <summary>
			///   Compute the bitwise AND of 128 bits (representing integer data) in "a" and "b", and store the result in
			///   "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			// _mm_xor_si128
			/// <summary>
			///   Compute the bitwise XOR of 128 bits (representing integer data) in "a" and "b", and store the result in
			///   "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			// _mm_cvtepi32_pd
			/// <summary>
			///   Convert packed 32-bit integers in "a" to packed double-precision (64-bit) floating-point elements, and store
			///   the results in "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <returns>Vector</returns>
			...
			// _mm_cvtsi32_sd
			/// <summary>
			///   Convert the 32-bit integer "b" to a double-precision (64-bit) floating-point element, store the result in the
			...
			// _mm_cvtsi64_sd
			/// <summary>
			///   Convert the 64-bit integer "b" to a double-precision (64-bit) floating-point element, store the result in the
			///   lower element of "dst", and copy the upper element from "a" to the upper element of "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			...
			// _mm_cvtepi32_ps
			/// <summary>
			///   Convert packed 32-bit integers in "a" to packed single-precision (32-bit) floating-point elements, and store
			///   the results in "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <returns>Vector</returns>
			...
			/// <param name="e15">Value 15</param>
			/// <param name="e14">Value 14</param>
			/// <param name="e13">Value 13</param>
			/// <param name="e12">Value 12</param>
			/// <param name="e11">Value 11</param>
			/// <param name="e10">Value 10</param>
			/// <param name="e9">Value 9</param>
			/// <param name="e8">Value 8</param>
			/// <param name="e7">Value 7</param>
			/// <param name="e6">Value 6</param>
			/// <param name="e5">Value 5</param>
			/// <param name="e4">Value 4</param>
			...
			// _mm_packs_epi16
			/// <summary>
			///   Convert packed 16-bit integers from "a" and "b" to packed 8-bit integers using signed saturation, and store
			///   the results in "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			// _mm_packs_epi32
			/// <summary>
			///   Convert packed 32-bit integers from "a" and "b" to packed 16-bit integers using signed saturation, and store
			///   the results in "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			// _mm_packus_epi16
			/// <summary>
			///   Convert packed 16-bit integers from "a" and "b" to packed 8-bit integers using unsigned saturation, and store
			///   the results in "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			// _mm_shufflelo_epi16
			/// <summary>
			///   Shuffle 16-bit integers in the low 64 bits of "a" using the control in "imm8". Store the results in the low
			///   64 bits of "dst", with the high 64 bits being copied from from "a" to "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="imm8">Control</param>
			/// <returns>Vector</returns>
			...
			///   (64-bit) floating-point element in "b", store the result in the lower element of "dst", and copy the upper element
			...
			// _mm_max_sd
			/// <summary>
			///   Compare the lower double-precision (64-bit) floating-point elements in "a" and "b", store the maximum value
			...
			// _mm_min_sd
			/// <summary>
			///   Compare the lower double-precision (64-bit) floating-point elements in "a" and "b", store the minimum value
			///   in the lower element of "dst", and copy the upper element from "a" to the upper element of "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			// _mm_sqrt_sd
			/// <summary>
			///   Compute the square root of the lower double-precision (64-bit) floating-point element in "b", store the
			...
			///   (64-bit) floating-point element in "a", store the result in the lower element of "dst", and copy the upper element
			///   from "a" to the upper element of "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			///   store the result in the lower element of "dst", and copy the upper element from "a" to the upper element of "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			/// <returns>Vector</returns>
			...
			// _mm_cmpgt_sd
			/// <summary>
			///   Compare the lower double-precision (64-bit) floating-point elements in "a" and "b" for greater-than, store
			...
			///   not-less-than-or-equal, store the result in the lower element of "dst", and copy the upper element from "a" to the
			...
			// _mm_cmpngt_sd
			/// <summary>
			///   Compare the lower double-precision (64-bit) floating-point elements in "a" and "b" for not-greater-than,
			///   store the result in the lower element of "dst", and copy the upper element from "a" to the upper element of "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			/// <summary>
			///   Compare the lower double-precision (64-bit) floating-point elements in "a" and "b" for
			///   not-greater-than-or-equal, store the result in the lower element of "dst", and copy the upper element from "a" to the
			///   upper element of "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			// _mm_cmpnge_pd
			/// <summary>
			///   Compare packed double-precision (64-bit) floating-point elements in "a" and "b" for
			///   not-greater-than-or-equal, and store the results in "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			/// <returns>Vector</returns>
			...
			// _mm_comigt_sd
			/// <summary>
			///   Compare the lower double-precision (64-bit) floating-point element in "a" and "b" for greater-than, and
			///   return the boolean result (0 or 1).
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			///   floating-point element, store the result in the lower element of "dst", and copy the upper element from "a" to the
			///   upper element of "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			// _mm_cvttsd_si32
			/// <summary>
			///   Convert the lower double-precision (64-bit) floating-point element in "a" to a 32-bit integer with
			...
			// _mm_cvttsd_si64
			/// <summary>
			///   Convert the lower double-precision (64-bit) floating-point element in "a" to a 64-bit integer with
			///   truncation, and store the result in "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <returns>64-bit integer</returns>
			...
			/// <param name="memAddr">Memory address</param>
			/// <returns>Vector</returns>
			public static v128 loadu_si32(void* memAddr)
			{
				return new v128(*(int*)memAddr, 0, 0, 0);
			}
			...
			/// <param name="memAddr">Memory address</param>
			/// <param name="a">Vector a</param>
			public static void storeu_si32(void* memAddr, v128 a)
			{
				*(int*)memAddr = a.SInt0;
			}
