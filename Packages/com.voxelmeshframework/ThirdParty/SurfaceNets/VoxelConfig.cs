namespace Voxels.ThirdParty.SurfaceNets
{
	...
	/// </summary>
	public class VoxelConfig : IDisposable
	{
		/// <summary>
		...
		///   Properly disposes the NativeArray to prevent memory leaks.
		///   This is critical when working with persistent allocations
		///   in the Unity job system.
		/// </summary>
		public void Dispose() { }
	}
}
