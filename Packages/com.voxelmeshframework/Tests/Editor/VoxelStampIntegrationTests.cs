	...
	public class VoxelStampIntegrationTests
	{
		...
		public void StampAcrossAdjacentChunks_CopySharedOverlap_MakesSeamEqual()
		{
			...
			try
			{
				...
				var leftNvm = new Core.Meshing.NativeVoxelMesh(Allocator.TempJob);
				leftNvm.volume = left;
				...
				var rightNvm = new Core.Meshing.NativeVoxelMesh(Allocator.TempJob);
		...
		public void StampAcrossFourChunks_CopySharedOverlap_MakesBothSeamsEqual()
		{
			...
			try
			{
				...
				var nvmA = new Core.Meshing.NativeVoxelMesh(Allocator.TempJob);
				nvmA.volume = a;
				...
				hA.Complete();
				var nvmB = new Core.Meshing.NativeVoxelMesh(Allocator.TempJob);
				nvmB.volume = b;
				...
				hB.Complete();
				var nvmC = new Core.Meshing.NativeVoxelMesh(Allocator.TempJob);
				nvmC.volume = c;
				...
				hC.Complete();
				var nvmD = new Core.Meshing.NativeVoxelMesh(Allocator.TempJob);
				nvmD.volume = d;
