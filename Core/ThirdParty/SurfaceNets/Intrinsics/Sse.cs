namespace Voxels.Core.ThirdParty.SurfaceNets.Intrinsics
{
	...
	public static unsafe partial class X86F
	{
		...
		public static class Sse
		{
			...
			/// <summary>
			///   Store 128-bits (composed of 4 packed single-precision (32-bit) floating-point elements) from "a" into memory using a
			...
			public static void stream_ps(void* memAddr, v128 a)
			{
			...
			// _mm_cvtsi32_ss
			/// <summary>
			///   Convert the 32-bit integer "b" to a single-precision (32-bit) floating-point element, store the result in the
			...
			// _mm_cvtsi64_ss
			/// <summary>
			///   Convert the 64-bit integer "b" to a single-precision (32-bit) floating-point element, store the result in the
			///   lower element of "dst", and copy the upper 3 packed elements from "a" to the upper elements of "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			...
			///   (32-bit) floating-point element in "a", store the result in the lower element of "dst", and copy the upper 3 packed
			...
			// _mm_sub_ps
			/// <summary>
			///   Subtract packed single-precision (32-bit) floating-point elements in "b" from packed single-precision
			...
			///   (32-bit) floating-point element in "b", store the result in the lower element of "dst", and copy the upper 3 packed
			///   elements from "a" to the upper elements of "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			// _mm_sqrt_ss
			/// <summary>
			///   Compute the square root of the lower single-precision (32-bit) floating-point element in "a", store the
			///   result in the lower element of "dst", and copy the upper 3 packed elements from "a" to the upper elements of "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <returns>Vector</returns>
			...
			///   store the result in the lower element of "dst", and copy the upper 3 packed elements from "a" to the upper elements
			...
			///   in "a", store the result in the lower element of "dst", and copy the upper 3 packed elements from "a" to the upper
			...
			// _mm_min_ss
			/// <summary>
			///   Compare the lower single-precision (32-bit) floating-point elements in "a" and "b", store the minimum value
			...
			// _mm_max_ss
			/// <summary>
			///   Compare the lower single-precision (32-bit) floating-point elements in "a" and "b", store the maximum value
			///   in the lower element of "dst", and copy the upper element from "a" to the upper element of "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			// _mm_cmpgt_ss
			/// <summary>
			///   Compare the lower single-precision (32-bit) floating-point elements in "a" and "b" for greater-than, store
			///   the result in the lower element of "dst", and copy the upper 3 packed elements from "a" to the upper elements of
			///   "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			///   not-less-than-or-equal, store the result in the lower element of "dst", and copy the upper 3 packed elements from "a"
			...
			/// <summary>
			///   Compare the lower single-precision (32-bit) floating-point elements in "a" and "b" for
			///   not-greater-than-or-equal, store the result in the lower element of "dst", and copy the upper 3 packed elements from
			...
			// _mm_cmpnge_ps
			/// <summary>
			///   Compare packed single-precision (32-bit) floating-point elements in "a" and "b" for
			...
			// _mm_comigt_ss
			/// <summary>
			///   Compare the lower single-precision (32-bit) floating-point element in "a" and "b" for greater-than, and
			///   return the boolean result (0 or 1).
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			...
			// _mm_cvt_ss2si
			/// <summary>
			///   Convert the lower single-precision (32-bit) floating-point element in "a" to a 32-bit integer, and store the result
			///   in "dst".
			...
			// _mm_cvtss_si64
			/// <summary>
			///   Convert the lower single-precision (32-bit) floating-point element in "a" to a 64-bit integer, and store the result
			///   in "dst".
			///   Follows standard of rounding to nearest, and for midpoint rounding it rounds to even.
			/// </summary>
			/// <param name="a">Vector a</param>
			...
			// _mm_cvttss_si32
			/// <summary>
			///   Convert the lower single-precision (32-bit) floating-point element in "a" to a 32-bit integer with
			...
			{
				using (var csr = new RoundingScope(MXCSRBits.ROUND_TOWARD_ZERO))
				{
					return (int)a.Float0;
				}
			}
			...
			// _mm_cvttss_si64
			/// <summary>
			///   Convert the lower single-precision (32-bit) floating-point element in "a" to a 64-bit integer with
			///   truncation, and store the result in "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <returns>64-bit integer</returns>
			...
			///   copy the upper 3 elements from "a" to the upper elements of "dst".
			/// </summary>
			/// <param name="a">Vector a</param>
			/// <param name="b">Vector b</param>
			/// <returns>Vector</returns>
			...
			{
				var dst = 0;
				if ((a.UInt0 & 0x80000000) != 0)
					dst |= 1;
				if ((a.UInt1 & 0x80000000) != 0)
					dst |= 2;
				if ((a.UInt2 & 0x80000000) != 0)
					dst |= 4;
				if ((a.UInt3 & 0x80000000) != 0)
					dst |= 8;
				return dst;
			}
			...
			public static void TRANSPOSE4_PS(ref v128 row0, ref v128 row1, ref v128 row2, ref v128 row3)
			{
				...
				tmp0 = shuffle_ps(row0, row1, 0x44);
				tmp2 = shuffle_ps(row0, row1, 0xEE);
				tmp1 = shuffle_ps(row2, row3, 0x44);
				tmp3 = shuffle_ps(row2, row3, 0xEE);

				row0 = shuffle_ps(tmp0, tmp1, 0x88);
				row1 = shuffle_ps(tmp0, tmp1, 0xDD);
				row2 = shuffle_ps(tmp2, tmp3, 0x88);
				row3 = shuffle_ps(tmp2, tmp3, 0xDD);
			}
			...
			/// <param name="memAddr">Memory address</param>
			/// <returns>Vector</returns>
			public static v128 loadu_si16(void* memAddr)
			{
				return new v128(*(short*)memAddr, 0, 0, 0, 0, 0, 0, 0);
			}
			...
			/// <param name="memAddr">Memory address</param>
			/// <param name="a">Vector a</param>
			public static void storeu_si16(void* memAddr, v128 a)
			{
				*(short*)memAddr = a.SShort0;
			}
			...
			/// <param name="memAddr">Memory address</param>
			/// <returns>Vector</returns>
			public static v128 loadu_si64(void* memAddr)
			{
				return new v128(*(long*)memAddr, 0);
			}
			...
			/// <param name="memAddr">Memory address</param>
			/// <param name="a">Vector a</param>
			public static void storeu_si64(void* memAddr, v128 a)
			{
				*(long*)memAddr = a.SLong0;
			}
		}
	}
}
